...
process.load("Configuration.GenProduction.LHE_Producer_AToZhToNuNuBB_M225_cff")
...
process.externalLHEProducer.args = cms.vstring('../AToZhToNuNuBB_01j_4f_M225_tarball.tar.xz')
